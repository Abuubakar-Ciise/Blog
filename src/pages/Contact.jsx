...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      "service_htpcuxs", // Replace with your EmailJS service ID
      "template_2g34rpg", // Replace with your EmailJS template ID
      formData,
      "FbwINVHqM10th-DC9" // Replace with your EmailJS user ID (also called Public Key)
    ).then(
      (result) => {
